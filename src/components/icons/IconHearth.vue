<template>
<svg @click="like" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 :width="width" :height="height" viewBox="0 0 45.743 45.743" style="enable-background:new 0 0 45.743 45.743;" :fill="fill" stroke="red" stroke-width="3"
	 xml:space="preserve">
<g>
